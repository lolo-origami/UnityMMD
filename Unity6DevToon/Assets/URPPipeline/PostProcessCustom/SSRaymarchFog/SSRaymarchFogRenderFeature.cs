...
public class SSRaymarchFogFeature : LLPostProcessRFBase
{
    private SSRaymarchFogPass _pass;

    protected override void OnCreate()
    {
        _pass = new SSRaymarchFogPass(settings.renderPassEvent, settings.shader);
    }
    ...
    public override bool IsActiveThisFrame(ref RenderingData renderingData)
    {
        ...
        var comp = VolumeManager.instance.stack.GetComponent<SSRaymarchFog>();
