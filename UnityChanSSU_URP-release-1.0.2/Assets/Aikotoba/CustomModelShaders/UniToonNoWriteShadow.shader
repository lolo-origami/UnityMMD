Shader "UniToon/URP_2021_3/LitWriteNoShadow"
{
    Properties
    {
        _UniToonVer("UniToon Version", Int) = 1213
        ...
        [ToggleOff] _EnableMirror("EnableMirror", int) = 1
        _MirrorAdjust("Mirror Adjust", Range(0.0, 1.0)) = 0.5
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.yoship1639.unitoon/Shaders/URP_2021_2/LitInput.hlsl"
            #include "Packages/com.yoship1639.unitoon/Shaders/URP_2021_2/LitForwardPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Packages/com.yoship1639.unitoon/Shaders/URP_2021_2/LitInput.hlsl"
            #include "Packages/com.yoship1639.unitoon/Shaders/DepthOnlyPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Packages/com.yoship1639.unitoon/Shaders/URP_2021_2/LitInput.hlsl"
            #include "Packages/com.yoship1639.unitoon/Shaders/LitDepthNormalsPass.hlsl"
            ENDHLSL
        }
