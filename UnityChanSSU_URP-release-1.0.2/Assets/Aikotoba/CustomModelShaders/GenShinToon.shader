        ...
        Pass
        {
            ...
            half4 ToonPassFragment(Varyings input): COLOR
            {
                ...
                */
                ...
                // SWeight：决定阴影范围
                float SWeight = (input.lambert) * 0.5 + 1.125;
                ...
                //SFactor = floor(LightMapColor.a * input.color.r + 0.9f);
                half4 FinalColor;
                ...
                half4 specularColor = _EnableSpecular * _LightSpecColor * _SpecMulti * LightMapColor.g * spec;
