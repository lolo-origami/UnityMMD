...
Varyings SimpleLitPassVertexCustom(Attributes input)
{
...
half4 SimpleLitPassFragmentCustom(Varyings input) : SV_Target
{
    UNITY_SETUP_INSTANCE_ID(input);
    ...
    half4 color = UniversalFragmentBlinnPhong(inputData, surfaceData) + reflectColor;
