Shader "Universal Render Pipeline/CustomLit"
{
    Properties
    {
        ...
        _Contrast("Contrast", Range(0, 20)) = 10
        
        [Toggle(ENABLE_MAZIORA)] _EnableMiaziora("Enable Miaziora", Float) = 0.0
        _GradMap ("GradMap", 2D) = "white" { }
        [ToggleUI] _InvertGrad("_invertGrad", Float) = 0.0
        _BlendFactor("Blend Factor", Range(0.0, 1.0)) = 0.5
        _GradPower("GradPower", Float) = 1.2
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local_fragment ENABLE_MAZIORA
