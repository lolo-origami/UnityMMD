...
Shader "Universal Render Pipeline/CustomSimpleLit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma vertex SimpleLitPassVertexCustom
            #pragma fragment SimpleLitPassFragmentCustom
