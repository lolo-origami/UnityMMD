Shader "Universal Render Pipeline/URPLLToonBGTransparent2"
{
    Properties
    {
        [Header(MainTex)]
    ...
    SubShader
    {
        ...
        */
        ...
        Pass
        {
            ...
            #include "LLToonForwardLighting2.hlsl"
    ...
    CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.LLToonShader2"
}
