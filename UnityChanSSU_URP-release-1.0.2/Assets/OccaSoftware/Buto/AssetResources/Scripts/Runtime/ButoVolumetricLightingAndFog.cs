...
namespace OccaSoftware.Buto
{
    public class ButoVolumetricLightingAndFog : ScriptableRendererFeature
    {
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                void SetMaterialParameters()
				{
                    ...
                    void SetVolumeData()
                    {
                        ...
                        float[] blendFalloffs = new float[ButoCommon._MAXVOLUMECOUNT];
                        ...
                        for (int i = 0; i < volumeCount; i++)
                        {
                            ...
                            blendFalloffs[i] = FogDensityMask.FogVolumes[i].Falloff;
                        }
                        ...
                        if (volumeCount > 0)
                        {
                            ...
                            fogMaterial.SetFloatArray(Params.VolumeBlendFalloff.Id, blendFalloffs);
                        }
                    }
        ...
        private static class Params
        {
            ...
            public static Param VolumeBlendFalloff = new Param("_VolumeBlendFalloff");
        }
